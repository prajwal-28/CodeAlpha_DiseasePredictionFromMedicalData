...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            # Ensure target is binary (0 = healthy, 1 = disease)
            train_df[target_column_name] = train_df[target_column_name].apply(lambda x: 1 if x > 0 else 0)
            test_df[target_column_name] = test_df[target_column_name].apply(lambda x: 1 if x > 0 else 0)
